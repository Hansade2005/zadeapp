...
import { Search, SlidersHorizontal, MapPin, X, Briefcase } from 'lucide-react';
...
export interface JobFilters {
  ...
  userLat?: number;
  userLon?: number;
  sortBy: 'newest' | 'salary_high' | 'salary_low' | 'boosted' | 'distance';
}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  handleFilterChange('sortBy', e.target.value as JobFilters['sortBy'])
                }
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              >
